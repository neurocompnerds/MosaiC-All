...
To enable testing of software installation, we have provided toy data (adapted from https://github.com/parklab/MosaicForecast/tree/master/demo) which can be used to test installation of variant calling tools via docker setup or manual installation:
